...
module.exports = function (router) {
    router.get('/bills/:id', bills.getBill);
    router.get('/bills/',  bills.getAllBills);
    router.post('/bills/add/', bills.addBill);
    router.post('/bills/searchwithlimit/', utilities.verifyToken, bills.getBillBySearchWithLimit);
    router.post('/bills/search/', bills.getBillsBySearch);
    router.post('/bills/:id',bills.updateBill);
    router.delete('/bills/delete/:id', bills.deleteBill);
